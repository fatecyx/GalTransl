...
def preprocess_trans_list(trans_list, projectConfig, pre_dic, gpt_dic, tPlugins=None):
...
async def doLLMTranslSingleChunk(
    ...
    async with semaphore:
        ...
        # 翻译前处理
        preprocess_trans_list(split_chunk.trans_list, projectConfig, pre_dic, gpt_dic, tPlugins)
